 ...
 * Billing Service
 *
 * Handles Stripe integration: checkout sessions, subscription lifecycle,
 * invoice retrieval, and webhook event processing.
 */
...
export class BillingService {
  ...
  async createCheckoutSession(tenantId: string, dto: CreateCheckoutSessionDto) {
    ...
    const priceId = PLAN_PRICE_MAP[dto.planId];
    if (!priceId) {
